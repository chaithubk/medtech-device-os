...
4. Update `MEDTECH_VITALS_CONTRACT_VERSION` (the `/usr/share/medtech/contracts/VITALS_CONTRACT_VERSION` file is generated from this variable during `do_install()`).
